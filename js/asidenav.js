...
function openAsideMenu() {
    ...
    asideMenu.classList.remove('d-none');
}
...
containerPanel.addEventListener('click', function () {
    closeAsideMenu();
});
asidecloseIcon.addEventListener('click', function () {
    closeAsideMenu();
});

asideNavButton.addEventListener("click", function () {
